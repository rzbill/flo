...
const file_flo_v1_streams_proto_rawDesc = "" +
	"\n" +
	"\x14flo/v1/streams.proto\x12\x06flo.v1\"\xb5\x01\n" +
	...
	"\x05stats\x18\x01 \x03(\v2\x15.flo.v1.RetryDLQStatsR\x05stats2\x9d\a\n" +
	"\x0eStreamsService\x12C\n" +
	"\x06Create\x12\x1b.flo.v1.CreateStreamRequest\x1a\x1c.flo.v1.CreateStreamResponse\x12:\n" +
	...
	"\x04Tail\x12\x13.flo.v1.TailRequest\x1a\x19.flo.v1.SubscribeResponse0\x01\x12.\n" +
	"\x03Ack\x12\x12.flo.v1.AckRequest\x1a\x13.flo.v1.AckResponse\x121\n" +
	"\x04Nack\x12\x13.flo.v1.NackRequest\x1a\x14.flo.v1.NackResponse\x12I\n" +
	"\fListMessages\x12\x1b.flo.v1.ListMessagesRequest\x1a\x1c.flo.v1.ListMessagesResponse\x12I\n" +
	"\bGetStats\x12\x1d.flo.v1.GetStreamStatsRequest\x1a\x1e.flo.v1.GetStreamStatsResponse\x12@\n" +
	"\x05Flush\x12\x1a.flo.v1.FlushStreamRequest\x1a\x1b.flo.v1.FlushStreamResponse\x12L\n" +
	"\rDeleteMessage\x12\x1c.flo.v1.DeleteMessageRequest\x1a\x1d.flo.v1.DeleteMessageResponse\x12X\n" +
	"\x11ListRetryMessages\x12 .flo.v1.ListRetryMessagesRequest\x1a!.flo.v1.ListRetryMessagesResponse\x12R\n" +
	"\x0fListDLQMessages\x12\x1e.flo.v1.ListDLQMessagesRequest\x1a\x1f.flo.v1.ListDLQMessagesResponse\x12U\n" +
	"\x10GetRetryDLQStats\x12\x1f.flo.v1.GetRetryDLQStatsRequest\x1a .flo.v1.GetRetryDLQStatsResponseB(Z&github.com/rzbill/flo/api/flo/v1;flov1b\x06proto3"
