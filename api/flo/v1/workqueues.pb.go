...
type DequeueRequest struct {
	...
	Policy        *RetryPolicy           `protobuf:"bytes,8,opt,name=policy,proto3" json:"policy,omitempty"`                                 // optional retry policy for this group
...
func (x *DequeueRequest) GetPolicy() *RetryPolicy {
	if x != nil {
		return x.Policy
	}
	return nil
...
const file_flo_v1_workqueues_proto_rawDesc = "" +
	...
	"\x05Flush\x12\x1d.flo.v1.FlushWorkQueueRequest\x1a\x1e.flo.v1.FlushWorkQueueResponseB(Z&github.com/rzbill/flo/api/flo/v1;flov1b\x06proto3"
...
var file_flo_v1_workqueues_proto_goTypes = []any{
	...
	(*RetryPolicy)(nil),                // 47: flo.v1.RetryPolicy
}
...
func file_flo_v1_workqueues_proto_init() {
	...
	file_flo_v1_streams_proto_init()
	type x struct{}
